...
class Pipeline(object):
    ...
    def configure(self):
        self.pipeline = None
        pipelineTemplate = """
        rtpbin name=rtpbin max-rtcp-rtp-time-diff=500
        ...
        ! x264enc speed-preset={speed} option-string="{option_string}" tune=zerolatency intra-refresh=true quantizer=19 pass=5
        ! rtph264pay 
